<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Relatório: Histórico de Tech Leads por Contrato
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <h3 class="text-lg font-medium text-gray-900">Filtro do Relatório</h3>
                <form action="{{ route('relatorios.gerar') }}" method="POST" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="contrato_id" id="contrato_id" class="mt-1 block w-full md:w-1/2 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
            ...
            @if(isset($historico))
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <h3 class="text-lg font-medium text-gray-900 mb-1">
                        Histórico para o Contrato: <span class="font-bold">{{ $contrato->numero_contrato }}</span>
                    </h3>
                    <p class="text-sm text-gray-600 mb-4">Cliente: {{ $contrato->cliente->nome_empresa }}</p>
