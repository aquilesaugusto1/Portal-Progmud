<x-app-layout>
    @push('styles')
    {{-- Adiciona os estilos do FullCalendar e o CSS customizado --}}
    <style>
        #calendar {
            max-width: 1100px;
            margin: 0 auto;
        ...
        /* --- NOVO CSS PARA A VISÃO SEMANAL --- */
        /* Adiciona uma borda direita a todas as colunas de dia, exceto a última */
        .fc-timeGridWeek-view .fc-timegrid-body .fc-timegrid-col:not(:last-child) {
            border-right: 1px solid #e5e7eb; /* Cor da borda do Tailwind (gray-200) */
        }
    </style>
    @endpush
